...
/* end of markdown library */

$file = 'readme.md';

if(empty($_GET['file'])) {
  header('location: markdown.php?file='.$file);
  exit;
} else {
  echo '<p>Parsing <code>'.$_GET['file'].'</code> below this line.</p><hr>';
  //echo Markdown(fread(fopen($_GET['file'], 'r'), filesize($file)));
